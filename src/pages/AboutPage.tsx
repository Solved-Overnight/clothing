          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Founded in 2016, ARVANA began as a vision to create fashion that transcends 
                  trends and speaks to the individual. We believe that clothing should be more 
                  than just fabric – it should be a canvas for self-expression.
                </p>
                <p>
                  Our journey started with a simple mission: to provide high-quality, 
                  sustainable fashion that doesn't compromise on style or ethics. Today, 
                  we're proud to serve customers worldwide with our carefully curated 
                  collections.
                </p>
                <p>
                  Every piece in our collection is thoughtfully designed, ethically sourced, 
                  and crafted to last. We're not just creating clothes; we're building a 
                  community of conscious consumers who value quality over quantity.
                </p>
              </div>
            </div>
